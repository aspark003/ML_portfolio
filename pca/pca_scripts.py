...
class AB:
    ...
    def b(self):
        try:
            ...
            plt.figure(figsize=(10,8))
            plt.scatter(i_x[:,0], i_x[:,1], c='red', s=20, label='Original')
            plt.scatter(inverse_xpca[:,0], inverse_xpca[:,1], c='green', s=20, label='Inverse PCA')
            plt.legend()
            ...
            plt.figure(figsize=(10, 8))
            plt.scatter(i_x[:,2], i_x[:,3], c='red', s=20, label='Original')
            plt.scatter(inverse_xpca[:,2], inverse_xpca[:,3], c='green', s=20, label='Inverse PCA')
            plt.legend()
            ...
            plt.figure(figsize=(10, 8))
            plt.scatter(i_x[:, 4], i_x[:, 5], c='red', s=20, label='Original')
            plt.scatter(inverse_xpca[:, 4], inverse_xpca[:, 5], c='green', s=20, label='Inverse PCA')
            plt.legend()
            ...
            plt.figure(figsize=(10, 8))
            plt.scatter(i_x[:, 6], i_x[:, 7], c='red', s=20, label='Original')
            plt.scatter(inverse_xpca[:, 6], inverse_xpca[:, 7], c='green', s=20, label='Inverse PCA')
            plt.legend()
            ...
            plt.figure(figsize=(10, 8))
            plt.scatter(i_x[:, 8], i_x[:, 9], c='red', s=20, label='Original')
            plt.scatter(inverse_xpca[:, 8], inverse_xpca[:, 9], c='green', s=20, label='Inverse PCA')
            plt.legend()
